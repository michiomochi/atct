...
export const ja: Record<TranslationKey, string> = {
  ...
  "goal.review.title": "ゴールの確認待ち",
  "goal.review.description": "作業を進める前に、完了したゴールの引き継ぎを確認してください。",
  "goal.review.reason": "却下理由",
  "goal.review.approve": "確認して承認",
  "goal.review.reject": "確認を却下",
  "goal.review.conflict": "この確認は別のタブまたは別の人によって既に回答されています。",
  "goal.review.fetchLatest": "最新の確認を取得",
  "goal.review.submitting": "送信中...",
  "goal.review.error.update": "ゴールの確認を更新できませんでした。",
