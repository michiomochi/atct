...
export const ja: Record<TranslationKey, string> = {
  ...
  "goal.completion.reviewedBy": "確認者",
  "goal.completion.reason": "却下理由",
  "goal.completion.approve": "承認",
  "goal.completion.reject": "却下",
  "goal.completion.missingBy": "この完了を承認または却下する人の名前を入力してください。",
  ...
  "form.answer.error.answeredBy": "回答する人の名前を入力してください。",
  "form.required": "(必須)",
  "form.optional": "(任意)",
