export const en = {
  ...
  "goal.spec": "Spec",
  "goal.plan": "Plan",
  "goal.requestReport.unset": "Unset",
  "goal.status": "Status: {{status}}",
  "goal.tasks.title": "Tasks",
  "goal.diff.title": "Goal diff",
  "goal.diff.filesChanged": "Files changed",
  "goal.diff.insertions": "Insertions",
  "goal.diff.deletions": "Deletions",
  "goal.diff.binary": "Binary file",
  "goal.diff.loading": "Loading diff",
  "goal.diff.unknown": "Unknown",
  ...
  "goal.review.approve": "Approve review",
  "goal.review.reject": "Reject review",
  "goal.review.conflict": "This review has already been answered in another tab or by another person.",
  "goal.review.fetchLatest": "Fetch the latest review",
  "goal.review.submitting": "Submitting...",
  "goal.review.error.update": "Could not update the goal review.",
  ...
  "task.snooze.heading": "Snooze",
  "task.snooze.label": "Snoozed until",
  "task.snooze.oneDay": "1 day",
  "task.snooze.oneWeek": "1 week",
  "task.snooze.date": "Choose a date",
  "task.snooze.release": "Clear snooze",
  "task.snooze.submit": "Snooze until this date",
  "task.snooze.snoozing": "Updating snooze...",
  "task.snooze.active": "Snoozed until {{until}}",
  "task.snooze.error": "Could not update snooze.",
