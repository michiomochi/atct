...
func frozenWatchAgentActionCases() []watchAgentActionCase {
	return []watchAgentActionCase{
		...
		{name: "accepted task wakeup", eventName: "wakeup.unclaimed_doing", line: "atct wakeup: task 1 is doing without a work lock", decision: watchDecision{TaskID: "1"}, want: true},
		{name: "accepted task wakeup without handoff", eventName: "wakeup.claim_undelegated", line: "atct wakeup: task 1 has no handoff request", decision: watchDecision{TaskID: "1"}, want: true},
		{name: "accepted stale claim", eventName: "wakeup.claim_stale", line: "atct wakeup: task 1 has a stale claim", decision: watchDecision{TaskID: "1"}, want: true},
		{name: "lost monitor wakeup", eventName: "wakeup.monitor_lost", line: "atct wakeup: monitor for handoff h1 is lost; recover or replace its worker", decision: watchDecision{GoalID: "1", TaskID: "2", HandoffID: "h1"}, want: true},
		{name: "other task wakeup", eventName: "wakeup.handoff_unreceived", line: "atct wakeup: handoff h1 has no receipt", decision: watchDecision{HandoffID: "h1"}, want: false},
		{name: "wakeup discrepancy", eventName: "wakeup.discrepancy", line: "atct wakeup discrepancy: evaluated_unstarted_tasks=1 counted_unstarted_tasks=0", want: true},
